...
var findTask, findParams, map, startExtent;
...
function init() {
    ...
    var streetMapLayer = new esri.layers.ArcGISTiledMapServiceLayer("http://maps.oki.org/arcgis/rest/services/Basemaps/okibasemap_minimal/MapServer");
    map.addLayer(streetMapLayer);
    //define a popup template
    var popupTemplate = new esri.dijit.PopupTemplate({
        title: "",
        fieldInfos: [
        {fieldName: "OKIID", visible: true, label:"OKI ID"},
        {fieldName: "Main_Street", visible: true, label:"Main Street"},
        {fieldName: "Cross_St", visible:true, label:"Cross Street"},
    ...
    var featureLayer = new esri.layers.FeatureLayer("http://maps.oki.org/arcgis/rest/services/Layers/TrafficCounts/MapServer/0", {
        ...
        outFields: ['OKIID', 'Main_Street','Cross_St','AADT_','Year_', 'CountYear2000' , 'CountYear2003', 'CountYear2004', 'CountYear2005', 'CountYear2006', 'CountYear2007', 'CountYear2008', 'CountYear2009', 'CountYear2010', 'CountYear2011']
    });
    ...
    findTask = new esri.tasks.FindTask("http://maps.oki.org/arcgis/rest/services/Layers/TrafficCounts/MapServer/");

    //Create the find parameters
    findParams = new esri.tasks.FindParameters();
    findParams.returnGeometry = true;
    findParams.layerIds = [0];
    findParams.searchFields = ["Main_Street", "Cross_St", "Jurisdiction"];
...
function showResults(results) {
  ...
  $.each(results, function(i, result) {
    ...
    content += result.feature.attributes.Main_Street += at += result.feature.attributes.Cross_St+"</a>";
